...
for outerloop=2:length(loss_arr)           
            ...
            disp(strjoin(['2user-' main '-' part 'm_50K_1024_2.npy'],""))
            writeNPY(labels,strjoin(['2user-' main '-' part 'm_labels_50K_5.npy'],""));
            ...
            disp('2user-'+main+'-'+part+'m_50K_1024_2.npy')
            writeNPY(dataset,strjoin(['2user-' main '-' part 'm_50K_1024_2.npy'],""));
            ...
            disp(['2user-',main '-' part 'm_labels_50K_5.npy'])
            label=readNPY(strjoin(['2user-' main '-' part 'm_labels_50K_5.npy'],""));
            l=zeros(50000,1);
            for i=1:50000
                for j=1:5
                    if(label(i,j)==1)
            ...
            writeNPY(l,strjoin(['2user-' main '-' part 'm_labels_50K_1.npy'],""));

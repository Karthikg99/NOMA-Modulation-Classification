...
loss(1)=-44.8189408627481;
loss(2)=-30.4700877872899; 
...
writeNPY(labels,'2user-100&500-500m_labels_150K_5.npy');
clear all;
...
writeNPY(dataset,'2user-100&500-500m_150k_1024_2.npy');

clear all;
disp("creating second dataset");
data1=readNPY('2user-100&500-500m_150k_1024_2.npy');
...
writeNPY(dataset,'2user-100&500-500m_150k_2_1024.npy');
clear all;
disp("labels creation");
label=readNPY('2user-100&500-500m_labels_150K_5.npy');
l=zeros(150000,1);
for i=1:150000
    for j=1:5
        if(label(i,j)==1)
...
writeNPY(l,'2user-100&500-500m_labels_150k_1.npy');
